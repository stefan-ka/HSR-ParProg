...
public class SuperComputerGUI extends JPanel implements ActionListener, Observer {
	...
	public SuperComputerGUI(TheSupercomputer theSupercomputer) {
		...
		this.theSupercomputer.addObserver(this);
	...
	public void actionPerformed(ActionEvent e) {
		new TheSuperComputerWorker(theSupercomputer, resultLabel).execute();
	}
	...
	public void update(Observable o, Object arg) {
		if (o instanceof TheSupercomputer) {
			TheSupercomputer theSuperComputer = (TheSupercomputer) o;
			SwingUtilities.invokeLater(() -> {
				statusLabel.setText(theSuperComputer.getStatus());
			});
		}
	}
}