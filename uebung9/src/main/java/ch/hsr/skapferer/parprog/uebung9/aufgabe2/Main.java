...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		ActorRef manager = system.actorOf(Props.create(WorkerManager.class, 4 /* Worker */), "WorkerManager");

		ActorRef calculator = system.actorOf(Props.create(Calculator.class, manager), "Calculator");
